...
import (
	...
	admin_server "github.com/laityjet/mammoth/v0/internal/server/admin/server"
	auth_iface "github.com/laityjet/mammoth/v0/internal/server/auth"
	auth_server "github.com/laityjet/mammoth/v0/internal/server/auth/server"
	debug_server "github.com/laityjet/mammoth/v0/internal/server/debug/server"
	entiface "github.com/laityjet/mammoth/v0/internal/server/enterprise"
	logs_server "github.com/laityjet/mammoth/v0/internal/server/logs/server"
	metadata_server "github.com/laityjet/mammoth/v0/internal/server/metadata/server"
	pfsiface "github.com/laityjet/mammoth/v0/internal/server/pfs"
	"github.com/laityjet/mammoth/v0/internal/server/pfs/s3"
	pfs_server "github.com/laityjet/mammoth/v0/internal/server/pfs/server"
	ppsiface "github.com/laityjet/mammoth/v0/internal/server/pps"
	pps_server "github.com/laityjet/mammoth/v0/internal/server/pps/server"
	proxy_server "github.com/laityjet/mammoth/v0/internal/server/proxy/server"
	...
	version_server "github.com/laityjet/mammoth/v0/internal/version"
	version "github.com/laityjet/mammoth/v0/internal/version/versionpb"
	...
	lokiclient "github.com/laityjet/mammoth/v0/internal/lokiutil/client"
	auth_interceptor "github.com/laityjet/mammoth/v0/internal/middleware/auth"
	clientlog_interceptor "github.com/laityjet/mammoth/v0/internal/middleware/logging/client"
	...
	snapshot_server "github.com/laityjet/mammoth/v0/internal/snapshot"
	storage_server "github.com/laityjet/mammoth/v0/internal/storage"
